...
Spike S1 (Piper norsk stemme i WASM) og S2 (ordmarkering) — se plan i prosjektdokumentasjonen.
Stemme lastes ved første bruk fra Hugging Face (rhasspy/piper-voices) og caches lokalt.
I v1 skal stemme- og WASM-filer selvhostes i egne pakker.
